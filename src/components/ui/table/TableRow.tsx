...
interface TableRowProps {
  index: number;
  show: number | null;
  handleShow: QRL<(index: number | null) => void>;
  item: any;
}

export const TableRow = component$(
  ({ index, show, handleShow, item }: TableRowProps) => {
    return (
      <tr class="h-20 text-sm leading-none text-gray-800 bg-white hover:bg-gray-100 border-b border-t border-gray-100">
        <td class="pl-4 cursor-pointer">
          <div class="flex items-center">
            ...
            <div class="pl-4">
              ...
              <p class="text-xs leading-3 text-gray-600 pt-2">{item.email}</p>
            </div>
          </div>
        </td>
        <td class="pl-12">
          ...
          <div class="w-24 h-3 bg-gray-100 rounded-full mt-2">
            <div class="w-20 h-3 bg-green-progress rounded-full" />
          </div>
        </td>
        <td class="pl-16">
          <div class="flex items-center">
        ...
        <td class="px-7 2xl:px-0">
          ...
          {show == index && (
            <div class="bg-white shadow w-24 absolute z-30 right-0 mr-6 lg:mr-44">
